(function () {
  ...
  function fillIndicators() {
    ...
    byId("separacoes").textContent = fmt(movement.desligamentos);
    byId("exoneracoes").textContent = fmt(movement.exoneracoes);
    byId("demissoes").textContent = fmt(movement.demissoes);
  ...
  function startTicker() {
    ...
    const messages = [
      ...
      `Desligamentos: ${fmt(movement.desligamentos)} (${fmt(movement.exoneracoes)} exonerações, ${fmt(movement.demissoes)} demissões)`,
